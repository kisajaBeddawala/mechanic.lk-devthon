...
export default function ServicesPage() {
    ...
    useEffect(() => {
        const fetchMechanics = async () => {
            try {
                let url = 'http://mechaniclk-devthon-production.up.railway.app/api/mechanics';
                if (userLocation) {
    ...
    const handleCreateRequest = async () => {
        ...
        try {
            ...
            const res = await fetch('http://mechaniclk-devthon-production.up.railway.app/api/service-requests', {
                method: 'POST',
                headers: {
