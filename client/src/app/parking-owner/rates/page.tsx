...
export default function ManageRatesPage() {
    ...
    React.useEffect(() => {
        const fetchSpots = async () => {
            ...
            try {
                const res = await fetch('http://mechaniclk-devthon-production.up.railway.app/api/parking/my-spots', {
    ...
    const handleSave = async () => {
        ...
        try {
            const res = await fetch(`http://mechaniclk-devthon-production.up.railway.app/api/parking/${selectedSpotId}`, {
                method: 'PUT',
                headers: {
